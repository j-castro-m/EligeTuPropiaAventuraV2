...
import com.joelcastro.eligetupropiaaventura.fragments.ConfigurationFragment_;
import com.joelcastro.eligetupropiaaventura.fragments.HistoryListFragment_;
import com.joelcastro.eligetupropiaaventura.fragments.HistorySummaryFragment;
import com.joelcastro.eligetupropiaaventura.fragments.HistorySummaryFragment_;
...
@EActivity(R.layout.drawer_container_layout)
public class DrawerMenuActivity extends Activity {
    ...
    private void selectItem(int drawerItemSelection) {
        ...
        //PreferencesHelperBK ph = new PreferencesHelperBK(getBaseContext());
        ...
        if(drawerItemSelection==ITEM_DRAWER_SUMMARY_HISTORY){
            fragment = new HistorySummaryFragment_();
            args.putString(HistorySummaryFragment.LAST_HISTORY_ID, myPrefs.adventureName().get());
            fragment.setArguments(args);
        }
        else if(drawerItemSelection==ITEM_DRAWER_HISTORY_LIST){
            fragment = new HistoryListFragment_();
        }else if(drawerItemSelection==ITEM_DRAWER_SETTINGS){
            fragment = new ConfigurationFragment_();
        }
